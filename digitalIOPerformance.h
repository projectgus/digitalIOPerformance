 ...
 *   MCU: atmega32u4
 */
#if defined(F_CPU) && (F_CPU+0) == 8000000L && defined(USB_PID) && (USB_PID+0) == 0x9208 && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && defined(USB_VID) && (USB_VID+0) == 0x1B4F && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x87 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 12
...
#endif
/* Arduino board:
 *   atmegang/atmega168 | diecimila/atmega168
 *   Arduino NG or older/ATmega168 | Arduino Duemilanove or Diecimila/ATmega168
 *   MCU: atmega168
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x06 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega8
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x07 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
#endif
/* Arduino board:
 *   bt/atmega168 | mini/atmega168 | nano/atmega168 | pro/16MHzatmega168
 *   Arduino BT/ATmega168 | Arduino Mini/ATmega168 | Arduino Nano/ATmega168 | Arduino Pro or Pro Mini/ATmega168 (5V, 16 MHz)
 *   MCU: atmega168
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x06 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 8
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
#endif
/* Arduino board:
 *   bt/atmega328 | mini/atmega328 | nano/atmega328 | pro/16MHzatmega328
 *   Arduino BT/ATmega328 | Arduino Mini/ATmega328 | Arduino Nano/ATmega328 | Arduino Pro or Pro Mini/ATmega328 (5V, 16 MHz)
 *   MCU: atmega328p
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x0F && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 8
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
#endif
/* Arduino board:
 *   diecimila/atmega328 | uno
 *   Arduino Duemilanove or Diecimila/ATmega328 | Arduino/Genuino Uno
 *   MCU: atmega328p
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x0F && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega32u4
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && defined(USB_PID) && (USB_PID+0) == 0x803c && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && defined(USB_VID) && (USB_VID+0) == 0x2341 && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x87 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 12
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega328p
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 9 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x0F && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
#endif
/* Arduino board:
 *   fio | pro/8MHzatmega328
 *   Arduino Fio | Arduino Pro or Pro Mini/ATmega328 (3.3V, 8 MHz)
 *   MCU: atmega328p
 */
#if defined(F_CPU) && (F_CPU+0) == 8000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x0F && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 8
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega32u4
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && defined(USB_PID) && (USB_PID+0) == 0x8036 && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && defined(USB_VID) && (USB_VID+0) == 0x2341 && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x87 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 12
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega328p
 */
#if defined(F_CPU) && (F_CPU+0) == 8000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x0F && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega168
 */
#if defined(F_CPU) && (F_CPU+0) == 8000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x06 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 6
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
#endif
/* Arduino board:
 *   mega/atmega2560 | megaADK
 *   Arduino/Genuino Mega or Mega 2560/ATmega2560 (Mega 2560) | Arduino Mega ADK
 *   MCU: atmega2560
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x01 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 16
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
...
/* Arduino board:
 *   mega/atmega1280
 *   Arduino/Genuino Mega or Mega 2560/ATmega1280
 *   MCU: atmega1280
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x03 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 16
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega32u4
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && defined(USB_PID) && (USB_PID+0) == 0x8037 && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && defined(USB_VID) && (USB_VID+0) == 0x2341 && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x87 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 12
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega168
 */
#if defined(F_CPU) && (F_CPU+0) == 8000000L && (!defined(USB_PID) || !(USB_PID+0)) && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && (!defined(USB_VID) || !(USB_VID+0)) && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x06 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 8
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
 ...
 *   MCU: atmega32u4
 */
#if defined(F_CPU) && (F_CPU+0) == 16000000L && defined(USB_PID) && (USB_PID+0) == 0x8041 && defined(LED_BUILTIN) && (LED_BUILTIN+0) == 13 && defined(USB_VID) && (USB_VID+0) == 0x2341 && defined(SIGNATURE_2) && (SIGNATURE_2+0) == 0x87 && defined(NUM_ANALOG_INPUTS) && (NUM_ANALOG_INPUTS+0) == 12
#ifdef _DIGITALIO_MATCHED_BOARD
#error "This header's Arduino configuration heuristics have matched multiple boards. The header may be out of date."
#endif
#define _DIGITALIO_MATCHED_BOARD
